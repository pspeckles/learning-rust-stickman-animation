...
pub fn running_animation() -> AnimationFrames {
    ...
    let mut standing_pose = Graph::copy_graph(&base);
    {
        ...
        // root
        view.root_mut().set_point((200.0, 150.0).into());
        // right upper/lower hand
        view.right_upper_arm_mut().set_angle((E).into());
    ...
    let mut squatting_pose = Graph::copy_graph(&base);
    {
        ...
        // root
        view.root_mut().set_point((400.0, 150.0).into());
        // right upper/lower hand
        view.right_upper_arm_mut().set_angle((E + QUARTER).into());
